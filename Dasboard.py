...
from FrmMahasiswa import FrmMahasiswa
from FrmDosen import FrmDosen
...
class Dashboard:
    def __init__(self):
        ...
        # Tambahkan atribut baru untuk menyimpan indeks menu
        self.menu_index = {}
    ...
    def new_window(self, number, _class):
        if self.__level == 'dosen' or self.__level is None:
    ...
    def update_main_window(self, data):
        ...
        if loginvalid:
            ...
            # hapus semua menu sebelum menambahkan yang baru
            ...
            if level == 'admin':
                ...
                self.menu_index[self.__level] = self.menubar.index("Mahasiswa")
            elif level == 'dosen':
                self.menubar.add_cascade(label="Dosen", menu=self.dosen_menu)
                self.__level = 'Dosen'
                self.menu_index[self.__level] = self.menubar.index("Dosen")
            else:
                pass
